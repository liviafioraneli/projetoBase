...
namespace HelperStockBeta.Domain.Entities
{
    public sealed class Product : Entity
    {
        ...
        private void ValidationDomain (string name, string description, decimal price, int stock, string image)
        {
            ...
            DomainExceptionValidation.When(description.Length < 5, "Invalida short descriptions, minimum 5 characters.");
            ...
            DomainExceptionValidation.When(image.Length > 250, "Invalid ling URL, maximum 250 characteres.");
